...
export default function MovementForm({ type }) {
  ...
  // Nuevos estados para detalles de entrega
        ...
        <Card className="p-5 lg:col-span-2">
          ...
          <div className="mt-4 grid gap-4">
            ...
            <div className="grid gap-1.5">
              ...
              <Textarea rows={2} value={notes} onChange={e => setNotes(e.target.value)} placeholder="Ej. Se entrega con cargador original, mouse y estuche..." />
            </div>
          </div>
        </Card>
